...
return [
    ...
    'notifications' => [
        'notifications' => [
            // Mail kanalı sahip kararıyla projeden çıkarıldı (havale + WhatsApp akışı).
            // Backup başarı/başarısızlık olayları Laravel log'a yazılır;
            // storage/logs/laravel.log üzerinde takip edilir veya UptimeRobot
            // benzeri external monitor ile periodik doğrulama yapılır.
